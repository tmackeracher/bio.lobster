#' @title lonlat2planar
#' @description  convert lon/lat to a projected surface using projection
#' @param proj.type can be an internal code such as "utm20" or a proj4 argument. Output scale is defined in the +units=km (default for bio) or +units=m (default for proj)
#' @export
